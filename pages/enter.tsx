       ...
       <div className="grid border-b  w-full mt-8 grid-cols-2">
        <button
         className={cls(
          ...
          method === 'email' ? ' border-orange-500 text-orange-400' : 'border-transparent hover:text-gray-400 text-gray-500',
         )}
        ...
        <button
         className={cls(
          'pb-4 font-medium text-sm border-b-2',
          method === 'phone' ? ' border-orange-500 text-orange-400' : 'border-transparent hover:text-gray-400 text-gray-500',
         )}
